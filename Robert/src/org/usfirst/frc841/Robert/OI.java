...
public class OI {
    ...
    public JoystickButton bringInTote4;
    public JoystickButton openIntakes8;
    public JoystickButton spitOutTote1;
    public JoystickButton closeIntakes7;
    public JoystickButton pickUpTote6;
    public JoystickButton placeStackDown5;
    public JoystickButton openPincer3;
    public JoystickButton closePincer2;
    ...
    public OI() {
        ...
        closePincer2 = new JoystickButton(coDriver, 2);
        closePincer2.whileHeld(new ClosePincer());
        openPincer3 = new JoystickButton(coDriver, 3);
        openPincer3.whileHeld(new OpenPincer());
        placeStackDown5 = new JoystickButton(coDriver, 5);
        placeStackDown5.whileHeld(new PlaceStackDown());
        pickUpTote6 = new JoystickButton(coDriver, 6);
        pickUpTote6.whileHeld(new PickUpTote());
        closeIntakes7 = new JoystickButton(coDriver, 7);
        closeIntakes7.whileHeld(new HoldTote());
        spitOutTote1 = new JoystickButton(coDriver, 1);
        spitOutTote1.whileHeld(new SpitOutTote());
        openIntakes8 = new JoystickButton(coDriver, 8);
        openIntakes8.whileHeld(new ReleaseTote());
        bringInTote4 = new JoystickButton(coDriver, 4);
        bringInTote4.whileHeld(new BringInTote());
        ...
        SmartDashboard.putData("HuanSatckerDown", new HuanSatckerDown());

        SmartDashboard.putData("PickUpBinBack", new PickUpBinBack());

        SmartDashboard.putData("OpenClaw", new OpenClaw());

        SmartDashboard.putData("PickUpBinFront", new PickUpBinFront());
