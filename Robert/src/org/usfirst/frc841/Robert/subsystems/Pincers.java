...
public class Pincers extends Subsystem {
    ...
    SpeedController pincerMotor = RobotMap.pincersPincerMotor;
    AnalogInput pincersAngleSensor = RobotMap.pincersPincersAngleSensor;
     	...
     	class Update extends TimerTask{
    	 	private Pincers pincers;
    			...
    			public void run() {
    				...
    				if (pincers.EnablePID){
    					pincers.cloop.SetTunings(pincers.kp,pincers.ki,pincers.kd);
    					pincers.cloop.SetReference(Setpoint);
    					pincers.SetMotors(pincers.cloop.Compute(pincers.GetAngle()));
    					
    					if ( (Setpoint - (Setpoint* 0.03)) < pincers.GetAngle() && pincers.GetAngle() < (Setpoint + (Setpoint* 0.03))){
    ...
    public double GetAngle(){
    	return pincersAngleSensor.getVoltage();
    }
    public void SetMotors(double power){
    	pincerMotor.set( power );
